use bevy::prelude::*;
use rgl_input::{Binding, BindingApp, BindingId, BindingPlugin, Bindings, Key};
...
fn yo_not_yo(
    yo_binding: Binding<YoBinding>,
    not_yo_binding: Binding<NotYoBinding>,
    bindings: Res<Input<BindingId>>,
) {
